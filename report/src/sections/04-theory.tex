...
% This gives rise to the following abstract domains:

% \paragraph{Abstract bag of tuples}: For a set of possible tuples of a table $T$, the bag mapping $b : T \rightarrow \mathbb{N}$ is replaced by an abstract bag function $b^\#: T \rightarrow \mathbb{N}^\#$ mapping the  of possible tuples $T$ to an abstract domain over the natural numbers $\mathbb{N}^\#$.
%
% \paragraph{Bag of abstract tuples}: For a set of possible tuples of a table $T$, the bag mapping $b : T \rightarrow \mathbb{N}$ is replaced by an abstract bag function $b^\#: T^\# \rightarrow \mathbb{N}$ mapping the abstract domain of possible tuples $T^\#$ to the codomain of the natural numbers.
%
% \paragraph{Abstract bag of abstract tuples}: For a set of possible tuples of a table $T$, the bag mapping $b : T \rightarrow \mathbb{N}$ is replaced by an abstract bag function $b^\#: T^\# \rightarrow \mathbb{N}^\#$ mapping the abstract domain of possible tuples $T^\#$ to the abstract codomain over the natural numbers $\mathbb{N}^\#$.
%
% \paragraph{Set of tuples}: For a set of possible tuples of a table $T$, the bag mapping $b : T \rightarrow \mathbb{N}$ is replaced by an abstract bag function $b^\#: T^\# \rightarrow 1$ mapping the domain of possible tuples $T$ to the abstract codomain of the singleton set $1$.
%
% \paragraph{Set of abstract tuples}: For a set of possible tuples of a table $T$, the bag mapping $b : T \rightarrow \mathbb{N}$ is replaced by an abstract bag function $b^\#: T^\# \rightarrow 1$ mapping the abstract domain of possible tuples $T^\#$ to the abstract codomain of the singleton set $1$.
%
% \paragraph{Set of abstract tuples}: For a set of possible tuples of a table $T$, the bag mapping $b : t \rightarrow \mathbb{N}$ is replaced by an abstract bag function $b^\#: t \rightarrow 1$ mapping a abstract domain of an abstract singleton tuple $t$ to the abstract codomain of the singleton set $1$.
