...
\begin{proof}
    \pf\
    \suffices{ To show that $\clattice{X}{S}$ is a nonempty and finite lattice, as a nonempty finite lattice is a complete lattice \cite{moller_statitc_nodate}.}
    ...
    \end{proof}
    \step{nonempty}{$\clattice{X}{S}$ is nonempty.}
    \begin{proof}
    ...
    \qedstep
    \begin{proof}
        \pf\ By \stepref{lattice} and \stepref{finite}, \stepref{nonempty}.
    \end{proof}
\end{proof}
