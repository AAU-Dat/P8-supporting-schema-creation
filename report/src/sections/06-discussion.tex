...
Exactly this is the key difference that makes sure that our implementation is finite, whereas ~\cite{halder_abstract_2012} can be infinite.
...
Therefore, due to the need to discard some semantics, programs using these missing commands/actions cannot be analyzed.
...
This means that while SQAAL can handle non-terminating programs, there are many programs SQAAL cannot handle that Halder's implementation can manage.
