...
We later describe the abstract syntax; there will be no control structures, like if-statements and loops.
...
We say $b$ is some Boolean expression, where $S$ is a set of states done in the control structure.
