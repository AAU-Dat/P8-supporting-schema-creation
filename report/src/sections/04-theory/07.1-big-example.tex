...
Another case could be checking if it is possible to have accounts with names that are not in the format of the regular expression $[A-Z][a-z]^*\textvisiblespace [A-Z][a-z]^*$, which in this case would hold.
