...
\begin{definition}
    ...
    A lattice partition of $S$ in respect to $X$ $p_{X}(S)$ is a set where:
    \begin{itemize}
...
\begin{restatable}{theorem}{partition}\label{thm:partition}
    For a non-complete lattice $(S, \sqsubseteq, \sqcup, \sqcap)$ and a finite non-empty subset $X \subseteq S$ $(p_X(S), \sqsubseteq, \sqcup, \sqcap)$ is finite and complete lattice.
\end{restatable}
