...
For the set of integers $\mathbf{NUM}$, we will only consider $[a, b], [a, +\infty]$ and $[-\infty, b]$ where $a \leq b$ and $a, b \in \mathbf{NUM}$, as valid intervals.
...
\begin{align}
    ...
    \lang([a, b]) &= \left\{ n \in \mathbf{NUM} \middle| a \leq n \leq b \right\} \\
    \lang([a, +\infty]) &= \left\{ n \in \mathbf{NUM} \middle| a \leq n \right\} \\
    \lang([-\infty, b]) &= \left\{ n \in \mathbf{NUM} \middle| n \leq b \right\}
\end{align}
