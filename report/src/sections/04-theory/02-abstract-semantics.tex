...
\begin{align}
    \abssqlsem{\langle insert(v_d, \mathbf{v}_t, \mathbf{e}), \phi \rangle}(\rho_{\ab{d}}, \rho_{\ab{a}}) & = (\rho_{\ab{d}}[v_d\mapsto t'\cup s], \rho_{\ab{a}}) \\
...
\begin{align}
    \abssqlsem{C_{update}}(\env{\abstable}, \env{\absvars})
                                              & = \abssqlsem{\langle update(v_d, \mathbf{v}_t, \mathbf{e}), \abspred \rangle} (\env{\abstable}, \env{\absvars}) \\
...
\begin{align*}
    ...
    &= \abssqlsem{\langle delete(v_d, \mathbf{v}_t), \abspred \rangle} (\env{\abstable}, \env{\absvars}) \\
