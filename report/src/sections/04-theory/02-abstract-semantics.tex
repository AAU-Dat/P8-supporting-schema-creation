...
This section will introduce the syntatic sets and abstract syntax of SQAAL. In this paper a simplified version of the abstract syntax, presented in \cite{cortesi_abstract_2013}, is used. Where parts that are not used, have not been defined.
\begin{figure}[htb!]
     \center
    \begin{tabular}{l l}
