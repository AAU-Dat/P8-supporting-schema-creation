...
Data flow analysis is a fundamental technique within this domain, providing a systematic approach to analyzing software behaviour.
Abstract interpretation, a powerful tool within data flow analysis, offers a method to examine software behaviour through static analysis.
Static program analysis, specifically abstract interpretation, is particularly useful for finding information guaranteed to hold in all executions of a program~\cite{jackson_software_2000}.
In this paper, we employ abstract interpretation, a specialized form of data flow analysis, to analyze software behaviour.
...
Constantly changing database contexts under Cortesi and Halder's framework may lead to analysis termination issues. \todo{Gabriela, are you sure about this?, wouldn't the definition given on page 145 of (Halder Cortesi), (abstract insert) be used for this and since it is based on set union, then reach a fixed point?}
