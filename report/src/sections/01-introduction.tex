...
This way, we can analysis the program and afterward check if for all possible steps of the program the invariant holds.
...
The invariants can be checked with the syntax which is described in \autoref{fig:abstract-syntax}.
