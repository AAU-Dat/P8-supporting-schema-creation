...
\IEEEPARstart{S}{oftware} analysis is a broad field encompassing various techniques and methodologies, each designed to address specific aspects of software systems.
Among these techniques, data flow analysis is a fundamental method for systematically analyzing software behaviour.
Within data flow analysis, abstract interpretation emerges as a powerful tool for examining software behaviour through static analysis.
...
This paper leverages abstract interpretation, a specialized form of data flow analysis, to analyze software behaviour.
