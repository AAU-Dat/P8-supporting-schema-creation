...
Show the contributions through a second example that runs through how we used the updated semantics.\todo{Casper says: I assume this is to be filled out later?}
