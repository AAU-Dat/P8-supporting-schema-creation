...
Where they only abstract over tuples, this paper abstracts over the multiplicity of both the tuples and values in the database, ultimately guaranteeing a finite analysis.
